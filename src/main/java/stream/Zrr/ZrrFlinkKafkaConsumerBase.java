 ...
 */
@Internal
public abstract class ZrrFlinkKafkaConsumerBase<T> extends RichParallelSourceFunction<T> implements
        CheckpointListener,
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase.class);
     ...
     * The value of this can only be determined in {@link org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase#open(Configuration)} since it depends
     ...
     */
    public ZrrFlinkKafkaConsumerBase(
            List<String> topics,
     ...
     */
    public ZrrFlinkKafkaConsumerBase<T> assignTimestampsAndWatermarks(AssignerWithPunctuatedWatermarks<T> assigner) {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public ZrrFlinkKafkaConsumerBase<T> assignTimestampsAndWatermarks(AssignerWithPeriodicWatermarks<T> assigner) {
        checkNotNull(assigner);
     ...
     * @return The consumer object, to allow function chaining.
     */
    public ZrrFlinkKafkaConsumerBase<T> setCommitOffsetsOnCheckpoints(boolean commitOnCheckpoints) {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public ZrrFlinkKafkaConsumerBase<T> setStartFromEarliest() {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public ZrrFlinkKafkaConsumerBase<T> setStartFromLatest() {
    ...
    protected ZrrFlinkKafkaConsumerBase<T> setStartFromTimestamp(long startupOffsetsTimestamp) {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public ZrrFlinkKafkaConsumerBase<T> setStartFromGroupOffsets() {
     ...
     * {@link org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumerBase#setStartFromGroupOffsets()}) for that particular partition.
     *
     ...
     * @return The consumer object, to allow function chaining.
     */
    public ZrrFlinkKafkaConsumerBase<T> setStartFromSpecificOffsets(Map<KafkaTopicPartition, Long> specificStartupOffsets) {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public ZrrFlinkKafkaConsumerBase<T> disableFilterRestoredPartitionsWithSubscribedTopics() {
    ...
    public void open(Configuration configuration) throws Exception {
        ...
        // 获取缓存文件
        File truststoreFile = getRuntimeContext().getDistributedCache().getFile("truststore");
        // add by zhengm start
        properties.setProperty("ssl.truststore.location",truststoreFile.getAbsolutePath());
        // 获取缓存文件
        File keystoreFile = getRuntimeContext().getDistributedCache().getFile("keystore");

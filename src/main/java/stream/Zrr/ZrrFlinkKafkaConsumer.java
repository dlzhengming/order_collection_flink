 ...
 */
@PublicEvolving
public class ZrrFlinkKafkaConsumer<T> extends ZrrFlinkKafkaConsumerBase<T> {
     ...
     * @param props
     */
    public ZrrFlinkKafkaConsumer(String topic, DeserializationSchema<T> valueDeserializer, Properties props) {
     ...
     * @param props
     */
    public ZrrFlinkKafkaConsumer(String topic, KafkaDeserializationSchema<T> deserializer, Properties props) {
     ...
     * @param props
     */
    public ZrrFlinkKafkaConsumer(List<String> topics, DeserializationSchema<T> deserializer, Properties props) {
     ...
     * @param props
     */
    public ZrrFlinkKafkaConsumer(List<String> topics, KafkaDeserializationSchema<T> deserializer, Properties props) {
     ...
     * {@link org.apache.flink.streaming.connectors.kafka.FlinkKafkaConsumer#KEY_PARTITION_DISCOVERY_INTERVAL_MILLIS} in the properties), topics
     ...
     * @param props
     */
    public ZrrFlinkKafkaConsumer(Pattern subscriptionPattern, DeserializationSchema<T> valueDeserializer, Properties props) {
     ...
     * @param props
     */
    public ZrrFlinkKafkaConsumer(Pattern subscriptionPattern, KafkaDeserializationSchema<T> deserializer, Properties props) {
        this(null, subscriptionPattern, deserializer, props);
    }

    private ZrrFlinkKafkaConsumer(
            List<String> topics,
    ...
    @Override
    public ZrrFlinkKafkaConsumerBase<T> setStartFromTimestamp(long startupOffsetsTimestamp) {
